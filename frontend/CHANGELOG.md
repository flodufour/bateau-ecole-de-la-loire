...
2026-09-03 11:15 — [refactor] Full visual re-skin to a warm-paper/navy/orange editorial system (Archivo + Barlow + IBM Plex Mono, fully rounded buttons/pills, white bordered cards, translucent blurred header, flat single-tone photo scrims instead of gradients) — CSS and presentation classes only, no route/content/logic changes; see frontend/docs/architecture.md's Design system section for what changed and what was deliberately left out
